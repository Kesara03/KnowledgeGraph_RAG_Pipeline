...
*Interactive demonstration: Exploring entities and relationships in the Neo4j graph, followed by query execution showing how the system combines graph traversal with vector similarity search to generate accurate historical responses.*
